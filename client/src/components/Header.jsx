...
export function Header({ 
  ...
  return (
    <header className="w-full glass-panel sticky top-2 z-50 rounded-2xl md:rounded-3xl p-2.5 sm:p-3 md:p-4 border border-pink-500/30 shadow-2xl gpu-accelerated touch-manipulation">
      {/* Top Header Bar */}
        ...
        <div className="flex items-center gap-2 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-[10px] sm:text-[11px] text-pink-200/80 font-bold flex items-center gap-1 truncate">
              ...
              <span className="px-1.5 py-0.2 rounded-full bg-pink-500/20 text-pink-300 border border-pink-400/40 text-[8px] sm:text-[9px] font-black shrink-0">
                🌟 Lvl Up
              </span>
            </p>
          </div>
      ...
      {/* ========================================================================= */}
      {mobileMenuOpen && (
        <div className="xl:hidden mt-3 pt-3 border-t border-slate-800 animate-fadeIn space-y-2">
